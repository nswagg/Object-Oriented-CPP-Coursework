...
int main()
{
	string names[STUDENTS];		//Student's names
...
/*
* The inputData function gets a student's name and four
* test scores from the user. The name is stored in the
* names string array via a reference parameter and test
* scores are stored in the testScores parameter array.
*/
...
/*
* The calcGrade function calculates the averafe of the
* test scores passed into the testScores parameter and
* assigns a grade to the grad reference parameter.
*/
...
/*
* The displayData function displays the student's name
* that is passed into the name parameter, the test
* scores passed into testScores array parameter,
* the average passed into the average parameter, and
* the grade passed into the grade parameter.
*/
